...
function updateCanvasForTemplate(templateType) {
  ...
  if (templateType === 'compost') {
    ...
    bottomText.innerHTML = "Yes = Food scraps, food soiled paper. No = Plastic, glass, metal.";
    ...
    bottomText.innerHTML = "Yes = Paper, cardboard, glass, plastic, metal, and aluminum cans.<br>No = Styrofoam, plastic bags, plastic wrap, Styrofoam containers, plastic utensils.";
    ...
    bottomText.innerHTML = "Yes = plastic bags and wrap, plastic straws and utensils, plastic to-go containers, plastic lined paper.<br>No = food waste, recyclables.";
